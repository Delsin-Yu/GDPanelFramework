...
public static partial class PanelManager
{
    ...
    public static AsyncAwaitable OpenPanelAsync(
        ...
        AsyncInterop.ToAsync(continuation => OpenPanel(panel, continuation, previousPanelVisual, closePolicy));
    ...
    /// <returns>An awaitable that, when awaited, will asynchronously continues after this panel has closed.</returns>
    /// <remarks>This function provides an <see cref="AsyncAwaitable{TCloseArg}"/> for async/await styled programing, await this awaitable will suspend the control flow and resumes it when the panel closes, if you don't care when the panel closes, you can use the overload without this awaitable <see cref="OpenPanel{TOpenArg}(UIPanelArg1{TOpenArg},TOpenArg,PreviousPanelVisual,ClosePolicy)"/>.</remarks>
    public static AsyncAwaitable OpenPanelAsync<TOpenArg>(
        this UIPanelArg1<TOpenArg> panel,
        TOpenArg openArg,
        PreviousPanelVisual previousPanelVisual = PreviousPanelVisual.Visible,
        ClosePolicy closePolicy = ClosePolicy.Cache) =>
        AsyncInterop.ToAsync(continuation => OpenPanel(panel, openArg, continuation, previousPanelVisual, closePolicy));
    ...
    /// <param name="previousPanelVisual">When setting to <see cref="PreviousPanelVisual.Hidden"/>, the previous panel will become invisible.</param>
    /// <param name="closePolicy">When setting to <see cref="ClosePolicy.Delete"/>, the system will delete this panel after it's closed.</param>
    /// <remarks>This function provides an <paramref name="onPanelCloseCallback"/> to listen for panel close, if you don't care when the panel closes, you can use the overload without this callback <see cref="OpenPanel{TOpenArg}(UIPanelArg1{TOpenArg},TOpenArg,PreviousPanelVisual,ClosePolicy)"/>.</remarks>
        ...
        ClosePolicy closePolicy = ClosePolicy.Cache)
    {
        panel.ThrowIfUninitialized();
        PushPanelToPanelStack(panel, previousPanelVisual);
        panel.OpenPanelInternal(openArg, new(previousPanelVisual, closePolicy, null, onPanelCloseCallback));
    }
    ...
    /// <param name="previousPanelVisual">When setting to <see cref="PreviousPanelVisual.Hidden"/>, the previous panel will become invisible.</param>
    /// <param name="closePolicy">When setting to <see cref="ClosePolicy.Delete"/>, the system will delete this panel after it is closed.</param>
    /// <remarks>This function doesn't allocate/accept a callback to listen for panel close, if you do need this callback, use the async overload <see cref="OpenPanelAsync"/> or the overload with a callback <see cref="OpenPanel{TOpenArg}(UIPanelArg1{TOpenArg},TOpenArg,Action,PreviousPanelVisual,ClosePolicy)"/>.</remarks>
    public static void OpenPanel<TOpenArg>(
        this UIPanelArg1<TOpenArg> panel,
        TOpenArg openArg,
        PreviousPanelVisual previousPanelVisual = PreviousPanelVisual.Visible,
    ...
    /// <remarks>This function provides an <see cref="AsyncAwaitable{TCloseArg}"/> for async/await styled programing, await this awaitable will suspend the control flow and resumes it when the panel closes, if you don't care when the panel closes, you can use the overload without this awaitable <see cref="OpenPanel{TOpenArg,TCloseArg}(UIPanelArg2{TOpenArg,TCloseArg},TOpenArg,PreviousPanelVisual,ClosePolicy)"/>.</remarks>
    public static AsyncAwaitable<TCloseArg> OpenPanelAsync<TOpenArg, TCloseArg>(
        this UIPanelArg2<TOpenArg, TCloseArg> panel,
        TOpenArg openArg,
        PreviousPanelVisual previousPanelVisual = PreviousPanelVisual.Visible,
        ClosePolicy closePolicy = ClosePolicy.Cache) =>
        AsyncInterop.ToAsync<TCloseArg>(continuation => OpenPanel(panel, openArg, continuation, previousPanelVisual, closePolicy));
    ...
    /// <param name="previousPanelVisual">When setting to <see cref="PreviousPanelVisual.Hidden"/>, the previous panel will become invisible.</param>
    /// <param name="closePolicy">When setting to <see cref="ClosePolicy.Delete"/>, the system will delete this panel after it's closed.</param>
    /// <remarks>This function provides an <paramref name="onPanelCloseCallback"/> to listen for panel close, if you don't care when the panel closes, you can use the overload without this callback <see cref="OpenPanel{TOpenArg,TCloseArg}(UIPanelArg2{TOpenArg,TCloseArg},TOpenArg,PreviousPanelVisual,ClosePolicy)"/>.</remarks>
