...
/// </summary>
public abstract partial class UIPanelArg2<TOpenArg, TCloseArg> : UIPanelBase<TOpenArg, TCloseArg>
{
    /// <summary>
    /// Close this panel.
    /// </summary>
    ...
    /// </remarks>
    protected internal void ClosePanel(TCloseArg closeArg) => ClosePanelInternal(closeArg);
}